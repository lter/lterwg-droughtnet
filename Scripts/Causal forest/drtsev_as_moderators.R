...
te <- data.anpp1%>%
  ...
  dplyr::summarize(ANPP = mean(mass), relprecip.1 = mean(relprecip.1, na.rm = TRUE), relprecip.2 = mean(relprecip.2, na.rm = TRUE), relprecip.3 = mean(relprecip.3, na.rm = TRUE), relprecip.4 = mean(relprecip.4, na.rm = TRUE))#%>%
#  subset(relprecip.1 != "NaN")
...
ggsave( "C:/Users/ohler/Dropbox/Tim+Laura/IDE causal forest/figures/moderators_variable-importance_1.pdf",
        plot = last_plot(),
        device = "pdf",
        path = NULL,
        scale = 1,
...
ggsave( "C:/Users/ohler/Dropbox/Tim+Laura/IDE causal forest/figures/moderator_treatmenteffects_predictions_1.pdf",
        plot = last_plot(),
        device = "pdf",
        path = NULL,
        scale = 1,
...
ggsave( "C:/Users/ohler/Dropbox/Tim+Laura/IDE causal forest/figures/moderator_treatmenteffects_shap_1.pdf",
        plot = last_plot(),
        device = "pdf",
        path = NULL,
        scale = 1,
