...
trajectory_folder <- file.path(export_folder, "pre_vs_year_1_post_trajectory_plots")
summary_stats_folder <- file.path(export_folder, "pre_vs_year_1_post_summary_stats")
...
# Sites that have year 0 data but not year 1 post-treatment data
